FROM registry.cn-qingdao.aliyuncs.com/x-lab/nuclei:v1.6.0 as nuclei-env

FROM registry.cn-qingdao.aliyuncs.com/x-lab/prowler:v1.6.0 as prowler-env

FROM registry.cn-qingdao.aliyuncs.com/x-lab/custodian:v1.6.0
