...
import io.riskscanner.commons.utils.DBEncryptInterceptor;
import io.riskscanner.commons.utils.EncryptConfig;
import io.riskscanner.commons.utils.LogUtil;
import io.riskscanner.interceptor.UserDesensitizationInterceptor;
...
@Configuration
@MapperScan(basePackages = {"io.riskscanner.base.mapper", "io.riskscanner.xpack.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
...
public class MybatisConfig {
    ...
    public DBEncryptInterceptor dbEncryptInterceptor() {
        ...
        // 添加加密/解密配置
        configList.add(new EncryptConfig("io.riskscanner.base.domain.AccountWithBLOBs", "credential"));
        configList.add(new EncryptConfig("io.riskscanner.base.domain.UserKey", "secretKey"));
