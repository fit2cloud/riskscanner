...
insert into `plugin` ( `id`, `name`, `icon`, `update_time`) values ('fit2cloud-aws-plugin', '亚马逊AWS', 'aws.png', concat(unix_timestamp(now()), '001'));
insert into `plugin` ( `id`, `name`, `icon`, `update_time`) values ('fit2cloud-azure-plugin', '微软Azure', 'azure.png', concat(unix_timestamp(now()), '001'));
