...
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('1240a2b8-f7ef-47c3-8048-2dd95d6d5b54', 'Tencent EIP带宽峰值扫描', 1, 'HighRisk', 'Tencent  检测您账号下的弹性IP实例是否达到最低带宽要求', 'policies:\n    # 检测您账号下的弹性IP实例是否达到最低带宽要求\n    - name: tencent-eip-bandwidth\n      resource: tencent.eip\n      filters:\n        - type: bandwidth\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"按带宽计费的公网型实例的带宽峰值\",\"defaultValue\":\"10\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
...
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('21fc2518-3b2b-475a-8398-4b1d9f68cfdb', 'Tencent Redis实例网络类型扫描', 1, 'HighRisk', 'Tencent  检测您账号下的Redis实例是否运行在VPC网络环境下，是视为“合规”', 'policies:\n    # 检测您账号下的Redis实例是否运行在VPC网络环境下，是视为“合规”\n    - name: tencent-redis-network-type\n      resource: tencent.redis\n      filters:\n        - type: network-type\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"实例的网络类型\",\"defaultValue\":\"vpc\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
...
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('2c4de559-7182-44e7-9657-b97412f0f0a7', 'Tencent CDB实例网络类型扫描', 1, 'HighRisk', 'Tencent  账号下CDB实例已关联到VPC；若您配置阈值，则关联的VpcId需存在您列出的阈值中，视为“合规”', 'policies:\n    # 账号下CDB实例已关联到VPC；若您配置阈值，则关联的VpcId需存在您列出的阈值中，视为“合规”。\n    - name: tencent-cdb-instance-network-type\n      resource: tencent.cdb\n      filters:\n        - type: network-type\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"实例的网络类型\",\"defaultValue\":\"vpc\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
...
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('525d0b91-ca93-4d3d-8679-195aef136e0b', 'Tencent CLB公网访问扫描', 1, 'HighRisk', 'Tencent  账号下CLB不允许任意来源公网访问，视为“合规”', 'policies:\n    # 账号下CLB不允许任意来源公网访问，视为“合规”\n    - name: tencent-clb-acls\n      resource: tencent.clb\n      filters:\n        - type: acls\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"网络类型\",\"defaultValue\":\"INTERNAL\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('59a95d30-30d7-45bf-ac47-80afed002ade', 'Tencent CLB负载均衡实例关联到VPC扫描', 1, 'HighRisk', 'Tencent  账号下负载均衡实例已关联到VPC；若您配置阈值，则关联的VpcId需存在您列出的阈值中，视为“合规”，否则视为不合规', 'policies:\n    # 账号下负载均衡实例已关联到VPC；若您配置阈值，则关联的VpcId需存在您列出的阈值中，视为“合规”。\n    - name: tencent-clb-network-type\n      resource: tencent.clb\n      filters:\n        - type: network-type\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"负载均衡实例的网络类型\",\"defaultValue\":\"vpc\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
...
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('a0dca246-563a-49c3-8a43-3c537ba1fb36', 'Tencent CLB带宽峰值扫描', 1, 'HighRisk', 'Tencent  检测您账号下的CLB负载均衡实例是否达到最低带宽要求', 'policies:\n    # 检测您账号下的负载均衡实例是否达到最低带宽要求。\n    - name: tencent-clb-bandwidth\n      resource: tencent.clb\n      filters:\n        - type: bandwidth\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"按带宽计费的公网型实例的带宽峰值\",\"defaultValue\":\"10\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
...
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('c1b41cbc-1263-4d67-a7c6-cf064999c6f8', 'Tencent MongoDB实例网络类型扫描', 1, 'HighRisk', 'Tencent  检测您账号下的MongoDB实例是否运行在VPC网络环境下', 'policies:\n    # 检测您账号下的MongoDB实例是否运行在VPC网络环境下\n    - name: tencent-mongodb-network-type\n      resource: tencent.mongodb\n      filters:\n        - type: network-type\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"实例的网络类型\",\"defaultValue\":\"vpc\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('c95be861-6e0e-4404-9b21-5ccfcd94ee3f', 'Tencent MongoDB实例公网访问扫描', 1, 'HighRisk', 'Tencent  检测您账号下MongoDB实例不允许任意来源公网访问，视为“合规”', 'policies:\n    # 检测您账号下MongoDB实例不允许任意来源公网访问，视为“合规”\n    - name: tencent-mongodb-internet-access\n      resource: tencent.mongodb\n      filters:\n        - type: internet-access\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"启用公网访问\",\"defaultValue\":\"true\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('ca991f61-49a4-49b2-9d14-16ca338d8149', 'Tencent COS防盗链扫描', 1, 'HighRisk', 'Tencent  检测COS Bucket是否开启防盗链开关，已开通视为合规', 'policies:\n    # 检测COS Bucket是否开启防盗链开关，已开通视为合规。\n    - name: tencent-cos-bucket-referer\n      resource: tencent.cos\n      filters:\n        - type: bucket-referer\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"是否开启防盗链开关\",\"defaultValue\":\"true\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
INSERT INTO rule(id, name, status, severity, description, script, parameter, plugin_id, plugin_name, plugin_icon, last_modified, flag, scan_type) VALUES ('cb9320af-4ee6-4c11-8840-8ec4b9cc8276', 'Tencent CDB实例公网访问扫描', 1, 'HighRisk', 'Tencent  检测您账号下CDB实例不允许任意来源公网访问，视为“合规”', 'policies:\n    # 检测您账号下CDB实例不允许任意来源公网访问，视为“合规”\n    - name: tencent-cdb-internet-access\n      resource: tencent.cdb\n      filters:\n        - type: internet-access\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"启用公网访问\",\"defaultValue\":\"true\",\"required\":true}]', 'fit2cloud-qcloud-plugin', '腾讯云', 'qcloud.png', concat(unix_timestamp(now()), '003'), 1, 'custodian');
