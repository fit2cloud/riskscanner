...
(
    id                            varchar(50)           NOT NULL COMMENT '任务 ID',
    ...
    trigger_id                    varchar(255)          DEFAULT NULL COMMENT '触发 ID',
    ...
    rule_tags                     varchar(256)          DEFAULT NULL COMMENT '标签 IDs',
    account_id                    varchar(50)           DEFAULT NULL COMMENT '云账号 ID',
    plugin_id                     varchar(40)           DEFAULT NULL COMMENT '插件 ID',
...
(
    ...
    task_item_id                 varchar(50)         DEFAULT NULL COMMENT '任务项 ID',
    resource_id                  varchar(50)         DEFAULT NULL COMMENT '资源 ID',
    create_time                  bigint(13)          DEFAULT NULL COMMENT '创建时间',
...
(
    resource_id                varchar(50) NOT NULL DEFAULT '' COMMENT '资源 ID',
    rule_id                    varchar(50)          DEFAULT NULL COMMENT '规则 ID',
    apply_user                 varchar(50)          DEFAULT NULL COMMENT '申请人',
...
(
    id                         varchar(50)         NOT NULL,
    resource_id                varchar(50)         DEFAULT NULL COMMENT '资源主键 ID',
    f2c_id                     varchar(256)        DEFAULT NULL COMMENT '资源 ID（唯一标识）',
    resource_type              varchar(64)         DEFAULT NULL COMMENT '资源类型',
    plugin_id                  varchar(40)         DEFAULT NULL COMMENT '插件名称',
    plugin_name                varchar(40)         DEFAULT NULL COMMENT '云平台名称',
    plugin_icon                varchar(128)        DEFAULT NULL COMMENT '云平台图标',
    ...
    create_time                bigint(13)          DEFAULT NULL COMMENT '创建时间',
    update_time                bigint(13)          DEFAULT NULL COMMENT '更新时间',
    resource                   longtext            DEFAULT NULL COMMENT '资源 JSON',
    PRIMARY KEY (id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;